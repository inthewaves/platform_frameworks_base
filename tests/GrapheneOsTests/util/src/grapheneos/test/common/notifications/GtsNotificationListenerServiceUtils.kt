...
import grapheneos.test.common.TestUtils.ensure
import grapheneos.test.common.TestUtils.eventually
import android.service.notification.StatusBarNotification
import android.util.Log
import org.junit.Assert

object GtsNotificationListenerServiceUtils {

    private const val TAG = "GtsNotifListenerServUtils"
    ...
    fun cancelNotification(packageName: String, notificationId: Int) {
        val notificationService = GtsNotificationListenerService.getInstance()
    ...
    fun getNotifications(packageName: String): List<StatusBarNotification> {
        ...
        for (notification in notificationService.activeNotifications) {
            Log.d(TAG, "Found notification: $notification")
